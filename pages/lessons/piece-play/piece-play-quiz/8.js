...
export default function Page() {
  ...
  const [game, setGame] = useState(
    new Chess("8/pp3p1p/2p5/8/8/6P1/PPP4P/8 w - - 0 1"),
  );
  ...
  function pickSecond() {
    ...
    setStyleFirst({});
    setMessage("That's right! Black has two isolated pawns which are weak.");
  }
      ...
      <div className="container">
        <div className="text-box">
          ...
          <div className="text-body-div">
            <p className="text-body">Which pawn structure is worse?</p>
            <div
              onClick={pickFirst}
              style={styleFirst}
