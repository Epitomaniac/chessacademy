...
export default function Page() {
  ...
  const [game, setGame] = useState(
    new Chess("8/3p4/2pk1pp1/Pp6/1P3PP1/2PK4/8/8 w - - 0 1"),
  );
  ...
  function pickFirst() {
    ...
    setStyleSecond({});
    setMessage(
      "That's right! White has a passed pawn which forces black's king to constantly defend to prevent it from becoming a queen.",
    );
    setSquareStyles({
      a5: { border: "2px solid green", borderRadius: "50%" },
    });
  }
      ...
      <div className="container">
        <div className="text-box">
          ...
          <div className="text-body-div">
            <p className="text-body">Which side is better?</p>
            <div
              onClick={pickFirst}
              style={styleFirst}
