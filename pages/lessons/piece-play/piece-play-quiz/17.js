...
export default function Page() {
  ...
  const [game, setGame] = useState(
    new Chess("8/2p2pp1/ppbpk2p/8/8/PPN3PP/2PPKP2/8 w - - 0 1"),
  );
        ...
        <div className="text-box">
          ...
          <div className="text-body-div">
            <p className="text-body">
              Why does black have a more comfortable position?
            </p>
            <div
              onClick={pickFirst}
              style={styleFirst}
            ...
            >
              <p className="text-body">Because she has a more active king.</p>
            </div>
            <div
              onClick={pickSecond}
              style={styleSecond}
            ...
            >
              <p className="text-body">
                Because she has a long-range piece and there are pawns on both
                sides of the board.
              </p>
            </div>
          ...
          <div className="pages-div">
            <p className="pages-text">17/20</p>
          </div>
        </div>
