...
export default function Page() {
  ...
  const [game, setGame] = useState(
    new Chess("8/6p1/5p2/4pP2/3pP3/3P4/8/8 w - - 0 1"),
  );
        ...
        <div className="text-box">
          ...
          <div className="text-body-div">
            <p className="text-body">
              A group of pawns that protect each other on a diagonal:
            </p>
            <div
              onClick={pickFirst}
              style={styleFirst}
            ...
            >
              <p className="text-body">Pawn chain</p>
            </div>
            <div
              onClick={pickSecond}
              style={styleSecond}
            ...
            >
              <p className="text-body">Pawn structure</p>
            </div>
