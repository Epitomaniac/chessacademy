...
export default function Page() {
  ...
  const sections = [<One direct={direct} />];
  const [index, setIndex] = useState(0);

  function direct() {
    router.push("/lessons/basic-tactics/1");
  }

  function One({ direct }) {
    const [game, setGame] = useState(
      new Chess("5q2/8/8/8/3K4/8/8/6k1 b - - 0 1"),
    );
    ...
    function tryAgain() {
      setMessage("");
      setGame(new Chess("5q2/8/8/8/3K4/8/8/6k1 b - - 0 1"));
      setVisible(false);
      setDraggable(true);
    }
      ...
      <div className="container">
        <div className="text-box">
          <div className="text-title-div">
            <h2 className="text-title">Exercise 1</h2>
          </div>
          <div className="text-body-div">
            ...
            <p className="text-body">
              ...
              possible to make the checkmate challenging more for you! Good
              luck.
            </p>
