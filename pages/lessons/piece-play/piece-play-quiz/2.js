...
export default function Page() {
  ...
  const [game, setGame] = useState(new Chess("8/3kPK2/8/8/8/8/8/8 w - - 0 1"));
  ...
  function next() {
    router.push("/lessons/piece-play/piece-play-quiz/3");
  }

  function pre() {
    router.push("/lessons/piece-play/piece-play-quiz/1");
  }
      ...
      <div className="container">
        <div className="text-box">
          ...
          <div className="text-body-div">
            <p className="text-body">The act of turning a pawn into a queen:</p>
            <div
              onClick={pickFirst}
              style={styleFirst}
              className="first-option"
            >
              <p className="text-body">En passant</p>
            </div>
            <div
              onClick={pickSecond}
              style={styleSecond}
            ...
            >
              <p className="text-body">Promotion</p>
            </div>
            <div
              onClick={pickThird}
              style={styleThird}
            ...
            >
              <p className="text-body">Castling</p>
            </div>
